"""
Django settings for fancy_violet_2 project.
...
ROOT_URLCONF = 'fancy_violet_2.urls'
...
WSGI_APPLICATION = 'fancy_violet_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Fancy Violet Support <support@fancy-violet-2.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fancy_violet_2 API",
    "DESCRIPTION": "API documentation for fancy_violet_2 App",
    "VERSION": "v1",
}
